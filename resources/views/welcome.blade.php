...
<body
    ...
    <script type="module">
        ...
        // Request permission + ambil token
        async function requestPermission() {
            try {
                const token = await getToken(messaging, {
                    vapidKey: "BKtMM51QAivdiigrFrTm1LdZk98LgxLp2u5AI57k-Y4rl85zs3fzuGhmf3apQvaaEWZvGxyj3vZHw9dot4dPryE"
                });
                if (token) {
                    ...
                    console.log("⚠️ User belum izinkan notifikasi.");
                }
            } catch (err) {
        ...
        // Listener pesan saat browser aktif (foreground)
